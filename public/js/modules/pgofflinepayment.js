...
app.pgofflinepayment = {
    ...
    events: {
        ...
        init: function () {
            app.pgofflinepayment.events.switch();
            app.pgofflinepayment.events.delete();
    ...
    init: function () {
        app.pgofflinepayment.events.init();
        app.dataTable.custom({"url":'pgoffline/datatable'});
