...
@section('pageTitle')
    {{__('app.default_list_title',["app_name" => __('app.app_name'),"module"=> __('app.overseas')])}}
@endsection
...
@section('content')
    <div class="be-content">
        <div class="page-head">
            <h2>Overseas Payment Management</h2>
            <ol class="breadcrumb">
                    ...
                    <div class="col-sm-12 col-xs-12">
                        <div class="activity-but activity-space pull-left">
                            ...
                            <div class="addreport pull-right">
                                <a href="{{url('/overseas/add-new-agent')}}">
                                    <button class="btn btn-space btn-primary"><i
                                                class="icon mdi mdi-plus "></i> Add overseas payment
                                    </button>
                                </a>
                            </div>
                            <div class="addreport pull-right">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="panel panel-default panel-table">
                                <label>TO:</label> <input type="text" name="filterDate[tbl_overseas_payment.payment_date]" id="date1" style="width: 100px;" value="" />
                                <label>FROM:</label> <input type="text" name="filterDate1[tbl_overseas_payment.payment_date]" id="date2" style="width: 100px;" value="" />
...
<script src="{{url('js/modules/overseaspayment.js')}}"></script>
