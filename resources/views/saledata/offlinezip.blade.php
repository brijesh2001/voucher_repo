    ...
    <div class="be-content">
        <div class="page-head">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{url('/saledata/create-offline-zip')}}">Zip {{trans('app.management')}}</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                        <div class="panel-heading panel-heading-divider">Create Agent Invoice Zip</div>
                            ...
                            <form action="{{url('/saledata/generate-zip')}}" name="app_add_form" id="app_form" style="border-radius: 0px;" method="post" class="form-horizontal group-border-dashed">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-md-4">
                                        <input type="text" name="to" id="to" placeholder="To" class="form-control input-sm" required autocomplete="off" value="" />
                                    </div>
                                </div>
                                <div class="form-group">
