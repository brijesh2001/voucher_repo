                    ...
                    <td align="center">
                        <table align="center" border="0" width="100%" style="font-size: 11px;font-weight: bold;">
                            ...
                            <tr>
                                ...
                                <td bgcolor="#eeeeee" style="padding: 15px;border-top: 2px solid #cccccc;"></td>
                                <td bgcolor="#eeeeee" style="padding: 15px;border-top: 2px solid #cccccc;"></td>
                                <td bgcolor="#eeeeee" style="padding: 15px;border-top: 2px solid #cccccc;">{{number_format($amount,2)}}</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table align="right" border="0" width="35%">
                                        <tr>
                                            <td style="padding: 3px 0;">{{number_format($amount,2)}}</td>
                                        </tr>

                                        <tr>
                                            <td style="padding: 3px 0;">{{$amount}}</td>
                                        </tr>
                                        <tr>
